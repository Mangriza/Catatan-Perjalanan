...
if(empty($_SESSION['nik'])){ ?>
    ...
    alert('Maaf Anda belum Melakukan Login Akun');
                    ...
                    <div class="mb-4 text-gray-800">   
                        <?php
                            if(!empty(@$_GET['url'])){
                                ...
                                echo"<h1>Selamat datang di Aplikasi Peduli Diri.</h1>";
                                echo"<h5>Catatan Perjalanan</h5>";
                                
                                echo"Anda User, Login Sebagai : ";
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span> &copy; Aplikasi Peduli Diri 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
